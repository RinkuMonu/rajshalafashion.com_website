...
export default function CategoryPage() {
  ...
  useEffect(() => {
    ...
    setPage(1);
    setHasMore(true);
  }, [catagory1, priceRange, sortBy, specialFilters]);
  ...
  useEffect(() => {
        ...
        const queryParams = new URLSearchParams({
          ...
          sortOrder: sortBy === "oldest" ? "asc" :
            sortBy === "price-low" ? "asc" :
              "desc",
          page: page.toString(),   // default page
          limit: "12", // You can adjust this as needed
    ...
    fetchProducts()
  }, [baseUrl, referenceWebsite, catagory1, priceRange, sortBy, specialFilters,page])
            ...
            {filteredProducts.length === 0 && !loading ? (
              ...
              <>
                ...
                {!hasMore && filteredProducts.length > 0 && (
                  <p className="text-center text-gray-400 mt-10 italic">You've reached the end of the collection.</p>
                )}
              </>
            )}
          </div>
